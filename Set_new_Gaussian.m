% file that sets up parameters for the run
...
% To create a linear gradient from 1e16 to 20e16 uncomment here:
% Nd = linspace( 1e16*1e6 , 20e16*1e6 , nx );

% To create exponential doping gradient uncomment here:
Nd = exp(linspace(1, 20, nx)) * 1e16;
